/**
 * Email templates (German, theme-matched, email-client-safe inline styles).
 * Separate from email.ts because that file runs in the Node runtime
 * ('use node') and may only export actions — these are called from mutations.
 */
